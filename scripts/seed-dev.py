...
def seed_brand(client: httpx.Client) -> str:
    ...
    payload = {
        ...
        "website_url": "https://islandfresh.example.mu",
        "description": (
        ...
        "tone_of_voice": "warm, authentic, proud-of-origin, casual-professional with light humor",
        "color_palette": {
...
def seed_prompt_versions(client: httpx.Client) -> None:
    ...
    prompts = [
        {
            "name": "Generate Draft",
            "slug": "content-generation-generate-draft",
            ...
            "variables": {"keys": ["brand_name", "platform", "product_name", "tone", "pillars"]},
            "is_active": True,
        },
        {
            "name": "Review Compliance",
            "slug": "content-generation-review-compliance",
            "category": "content_generation",
            "version": 1,
            "template": (
            ...
            "variables": {"keys": ["brand_name", "brand_safety_rules", "draft_content"]},
            "is_active": True,
        },
        {
            "name": "Research Summary",
            "slug": "research-summary-summarize",
            "category": "other",
            "version": 1,
            "template": (
            ...
            "variables": {"keys": ["brand_name", "research_topic", "research_data"]},
            "is_active": True,
        },
        {
            "name": "Strategy Recommendation",
            "slug": "strategy-recommendation-recommend",
            "category": "other",
            "version": 1,
            "template": (
    ...
    for p in prompts:
        ...
        resp.raise_for_status()
        pv = resp.json()
        print(f"  Prompt version created: {pv['category']}/{pv['slug']} v{pv['version']}")
